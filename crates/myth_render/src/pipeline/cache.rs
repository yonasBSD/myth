...
use myth_resources::uniforms::{clustered_lighting_structs_wgsl, scene_lighting_structs_wgsl};
...
impl PipelineCache {
    ...
    pub fn get_or_create_graphics(
        ...
        opts.inject_code("scene_lighting_structs", scene_lighting_structs_wgsl());
        opts.inject_code(
